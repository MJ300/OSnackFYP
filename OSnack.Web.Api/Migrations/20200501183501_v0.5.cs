        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NewsletterSubscriptions_Tokens_TokenId",
                        column: x => x.TokenId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreProductStoreId = table.Column<int>(nullable: false),
                    StoreProductProductId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_StoreProducts_StoreProductStoreId_StoreProductProductId",
                        columns: x => new { x.StoreProductStoreId, x.StoreProductProductId },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Score", x => x.OrderItemId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsletterSubscriptions_TokenId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_StoreProductStoreId_StoreProductProductId",
                table: "OrderItems",
