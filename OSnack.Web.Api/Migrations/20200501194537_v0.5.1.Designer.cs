...
namespace OSnack.Web.Api.Migrations
{
    ...
    [Migration("20200501194537_v0.5.1")]
    partial class v051
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OSnack.Web.Api.Database.Models.oComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OSnack.Web.Api.Database.Models.oNewsletterSubscription", b =>
                {
            ...
            modelBuilder.Entity("OSnack.Web.Api.Database.Models.oRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OSnack.Web.Api.Database.Models.oScore", b =>
                {
                    b.Property<int>("OrderItemId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OSnack.Web.Api.Database.Models.oStore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OSnack.Web.Api.Database.Models.oStoreProduct", b =>
                {
                    b.Property<int>("StoreId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OSnack.Web.Api.Database.Models.oComment", b =>
                {
                    b.HasOne("OSnack.Web.Api.Database.Models.oOrderItem", "OrderItem")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("OSnack.Web.Api.Database.Models.oNewsletterSubscription", b =>
                {
                    b.HasOne("OSnack.Web.Api.Database.Models.oToken", "Token")
                        .WithMany()
            ...
            modelBuilder.Entity("OSnack.Web.Api.Database.Models.oOrder", b =>
                {
                    ...
                    b.HasOne("OSnack.Web.Api.Database.Models.oPayment", "Payment")
                        .WithOne("Order")
                        .HasForeignKey("OSnack.Web.Api.Database.Models.oOrder", "PaymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("OSnack.Web.Api.Database.Models.oOrderItem", b =>
                {
                    ...
                    b.HasOne("OSnack.Web.Api.Database.Models.oStoreProduct", "StoreProduct")
                        .WithMany()
            ...
            modelBuilder.Entity("OSnack.Web.Api.Database.Models.oProduct", b =>
                {
                    b.HasOne("OSnack.Web.Api.Database.Models.oCategory", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("OSnack.Web.Api.Database.Models.oScore", b =>
                {
                    b.HasOne("OSnack.Web.Api.Database.Models.oOrderItem", null)
                        .WithMany("Scores")
                        .HasForeignKey("OrderItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OSnack.Web.Api.Database.Models.oStoreProduct", b =>
                {
                    ...
                    b.HasOne("OSnack.Web.Api.Database.Models.oStore", "Store")
                        .WithMany("StoreProducts")
            ...
            modelBuilder.Entity("OSnack.Web.Api.Database.Models.oUser", b =>
                {
                    b.HasOne("OSnack.Web.Api.Database.Models.oRole", "Role")
                        .WithMany("Users")
